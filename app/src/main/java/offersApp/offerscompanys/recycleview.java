...
import offersApp.offerscompanys.databinding.ActivityRecycleviewBinding;
...
public class recycleview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(recycleview.this, 1);
        ...
        dataList.add(androidData);
        adapter = new MyAdapter(recycleview.this, dataList);
